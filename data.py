...
# Add tap-in heatmap
HeatMap(heat_data_in, radius=8, blur=10, gradient={0.4: 'blue', 0.65: 'lime', 1: 'red'}, name="Tap-In").add_to(m)
# Add tap-out heatmap
HeatMap(heat_data_out, radius=8, blur=10, gradient={0.4: 'purple', 0.65: 'orange', 1: 'red'}, name="Tap-Out").add_to(m)
...
sns.barplot(
    x=top_corridor.index,
    y=top_corridor.values,
    palette="viridis"
)
